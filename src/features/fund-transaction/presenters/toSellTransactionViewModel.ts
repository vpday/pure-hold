...
export function toSellTransactionViewModel(
  ...
  return {
    ...
    redemptionFee: toMoneyField(result.redemptionFee),
...
function fallbackCalculation(event: PortfolioSellEvent): PortfolioSellCalculation {
  return {
    ...
    grossAmount: event.grossAmount ?? unknownField(),
    netAmount: event.netAmount ?? unknownField(),
    realizedGain: unknownField(),
    realizedGainStatus: 'incomplete',
    redemptionFee: event.redemptionFee ?? unknownField(),
    settlementStatus: event.settlementStatus,
    unitNav: event.unitNav ?? unknownField(),
    units: event.units,
  }
}
